...
public class SelectionUtils
{
    ...
    public Unit GetTargetMonster(List<Unit> monsters)
    {
        ...
        HandleCancelSelection(objectiveSelection, monsters);
        return monsters[objectiveSelection-1];
    }
    ...
    public Unit GetTarget(Unit attacker)
    {
        ...
        Unit target = GetTargetMonster(possibleTargets);
        return target;
    }
    ...
    public Unit GetDeadAllyTarget(Unit attacker)
    {
        ...
        Unit target = GetTargetMonster(deadMonsters);
        return target;
    }
